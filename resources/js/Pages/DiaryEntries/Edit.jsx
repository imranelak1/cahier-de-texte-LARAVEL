...
export default function Edit({ auth, diaryEntry, modules, groups: initialGroups }) {
    ...
    useEffect(() => {
        if (values.module_id) {
            ...
            if (selectedModule) {
                // Filter groups based on the selected module's field and level
                const moduleGroups = initialGroups.filter(g => 
